...
@section('page_title', 'Создание курса')
...
@section('content')
    ...
    <form action="{{ route('courses.store') }}" method="POST" class="bg-white border border-gray-100 rounded-16 p-24">
        @csrf
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                ...
                <textarea name="description" rows="4" class="form-control" placeholder="Краткое описание курса">{{ old('description') }}</textarea>
            </div>

            <div class="col-12">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" name="is_active" id="course-active" value="1" @checked(old('is_active', true))>
